...
export const PALETTE_ADDRESS = 0x2000
export const PALETTE_ENTRY_SIZE = 4
export const PALETTE_LENGTH = 4
export const PALETTE_SIZE = PALETTE_ENTRY_SIZE * PALETTE_LENGTH
export const PALETTE_END = PALETTE_ADDRESS + PALETTE_SIZE
